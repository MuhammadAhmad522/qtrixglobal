    ...
    <>
      ...
      <section className="bg-concrete-white py-14 md:py-20">
        <Container className="grid items-start gap-8 lg:grid-cols-[minmax(0,2fr)_minmax(300px,1fr)]">
          <form
            className="border border-outline-variant bg-white p-6 md:p-10"
            onSubmit={(event) => {
          ...
          <aside className="space-y-6">
            <div className="bg-industrial-navy p-7 text-white md:p-8">
            ...
            <form className="bg-surface-container-high p-7" onSubmit={(event) => event.preventDefault()}>
            ...
            <div className="relative h-72 overflow-hidden border border-outline-variant">
      ...
      <section className="border-t border-outline-variant bg-white py-14 text-center">
        <Container>
          ...
          <div className="flex flex-wrap justify-center gap-5 md:gap-10">
            {['ISO 9001', 'FSC', 'CE', 'EN 397'].map((standard) => <div className="flex min-h-16 min-w-32 items-center justify-center border border-outline-variant px-5 font-heading font-bold text-steel-gray" key={standard}>{standard}</div>)}
          </div>
        </Container>
      </section>
    </>
